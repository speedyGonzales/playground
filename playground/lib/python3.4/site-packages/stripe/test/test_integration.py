...
class ChargeTest(StripeTestCase):
    ...
    def test_charge_dispute(self):
        ...
        self.assertRaisesRegex(stripe.error.InvalidRequestError,
...
class CustomerTest(StripeTestCase):
    ...
    def test_customer_delete_card(self):
        ...
        self.assertEqual(len(post_delete_customer.cards.data), 0)
...
class RecipientTest(StripeTestCase):
    ...
    def test_recipient_delete_card(self):
        ...
        self.assertEqual(len(post_delete_recipient.cards.data), 0)
...
class RefundTest(StripeTestCase):
    ...
    def test_update_refund(self):
        ...
        refund.save()
        self.assertEqual("value", refund.metadata["key"])
